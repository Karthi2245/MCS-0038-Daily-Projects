'''
Array:
--> Array is an object which stores a group of elements of same data type.
--> The main advantage of array is to store and process tha group of elements
easily.
Two point we should remember:
--> It should store the same data type which means, if u want to store integer
means u can store only integer not float, double and any character.
